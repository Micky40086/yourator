class Admin::JobsController < ApplicationController
  ...
  # GET /admin/jobs.json
  def index
    @admin_jobs = Admin::Job.includes(:company)
  end
  ...
  def create
    ...
    respond_to do |format|
      if @admin_job.save
        format.html { redirect_to admin_path, notice: "Job was successfully created." }
  ...
  def update
    respond_to do |format|
      if @admin_job.update(admin_job_params)
        format.html { redirect_to admin_path, notice: "Job was successfully updated." }
  ...
  def destroy
    @admin_job.destroy
    respond_to do |format|
      format.html { redirect_to admin_path, notice: "Job was successfully destroyed." }
  ...
  def admin_job_params
    params.require(:admin_job).permit(:admin_company_id, :name, :enabled, :intro, :condition, :welfare, :salary)
  end
end
